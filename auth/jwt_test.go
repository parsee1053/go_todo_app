...
import (
	...
	"github.com/parsee1053/go_todo_app/entity"
	"github.com/parsee1053/go_todo_app/store"
	"github.com/parsee1053/go_todo_app/testutil/fixture"
)
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/parsee1053/go_todo_app`).
